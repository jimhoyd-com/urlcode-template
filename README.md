...
values through `context.state`. Under the pinned `0.4.8` runtime
...
middleware.
See [middleware semantics for this pin](https://github.com/jimhoyd-com/urlcode/blob/v0.4.8/docs/MIDDLEWARE.md)
...
In the `0.4.8` runtime this template pins, `function` and `middleware`
...
[security model for this pin](https://github.com/jimhoyd-com/urlcode/blob/v0.4.8/docs/FUNCTION-SECURITY.md).
Never commit credentials, tokens or session cookies in YAML headers.

This template pins the `0.4.8` published local/self-hosted runtime. Review the
[release-readiness gates](https://github.com/jimhoyd-com/urlcode/blob/v0.4.8/docs/RELEASE-READINESS.md) before deployment. Read the
...
[Full guide](https://github.com/jimhoyd-com/urlcode/blob/v0.4.8/docs/SCAFFOLDING.md).
...
[security audit and remaining gates](https://github.com/jimhoyd-com/urlcode/blob/v0.4.8/docs/SECURITY-AUDIT.md) before production use.
...
[management security guide](https://github.com/jimhoyd-com/urlcode/blob/v0.4.8/docs/MANAGEMENT-SECURITY.md)
